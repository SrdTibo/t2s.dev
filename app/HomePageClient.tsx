...
export default function HomePageClient() {
  ...
  const skills = [
    {
      ...
      description: "Optimisation SEO technique et visibilité sur les moteurs de recherche.",
      icon: "🔍",
    },
    {
      label: "WordPress",
  ...
  const [errorToast] = useState(false);
