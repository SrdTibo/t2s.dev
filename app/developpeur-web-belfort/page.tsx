import DeveloperBelfortClient from "./DeveloperBelfortClient";
...
export const metadata = {
  ...
  openGraph: {
    ...
    url: "https://t2s.dev/developpeur-web-belfort",
    siteName: "T2S Développement",
    locale: "fr_FR",
    type: "website",
  },
  alternates: {
    canonical: "https://t2s.dev/developpeur-web-belfort",
  },
};

export default function DeveloperBelfortPage() {
  return <DeveloperBelfortClient />;
}
