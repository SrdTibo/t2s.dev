...
export default function DeveloperBelfortClient() {
        ...
        <div className="grid gap-10 md:grid-cols-[1.1fr_0.9fr] items-start">
          ...
          >
            ...
            <p className="mt-4 text-gray-400 text-sm md:text-base leading-relaxed max-w-lg">
              ...
              techniques&nbsp;? Décrivez votre projet et je reviens vers vous
              rapidement avec des pistes concrètes et adaptées à vos objectifs.
            </p>
            ...
            >
              ...
              <div className="space-y-2">
                ...
                <textarea
                  ...
                  placeholder="Parlez-moi de votre projet, de votre activité, de vos attentes..."
                />
              </div>
            ...
            >
              ...
              <div className="space-y-3 text-sm text-gray-200">
                <p className="text-gray-300">
                  Basé en France, disponible pour des projets à distance ou en
